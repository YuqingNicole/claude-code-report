...
## 6.7 agent-specific MCP servers：真正的 additive 能力注入
...
## 6.10 transcript / metadata / cleanup：产品化 runtime 的证据
runAgent() 里非常多产品级细节：
...
## 6.1 Skill：不是文档，而是 workflow package
...
## 6.2 Plugin：Prompt + Metadata + Runtime Constraints
