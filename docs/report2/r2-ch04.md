...
## 4.6 Session-specific guidance：运行时可变的局部指令
...
局部规则” 。
## 4.7 Output efficiency：高价值但常被忽视的 section
...
## 4.9 DEF AULT_AGENT_PROMPT：子 Agent 的基础人格
在 prompts.ts 里还定义了：
...
## 4.1 AgentTool/prompt.ts：Agent 协议说明书
